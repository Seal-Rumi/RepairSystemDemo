...
(function (global, factory) {
  ...
  function getRandomArbitrary(min, max) {
    var random = window.crypto.getRandomValues(new Uint32Array(1));
    random = random[0] / Math.pow(2, 32)
      ...
      $__default["default"].get(this._settings.source, this._settings.params, function (response) {
        if (_this._settings.loadInContent) {
          if (_this._settings.sourceSelector !== '') {
            let elem = $__default["default"](response).find(_this._settings.sourceSelector);
            response = elem.html()
          }

          let elem1 = _this._parent.find(_this._settings.content)
          elem1.html(response);
        }
  ...
  var IFrame = /*#__PURE__*/function () {
    ...
    _proto.createTab = function createTab(title, link, uniqueName, autoOpen) {
      ...
      if (this._config.allowDuplicates) {
        tabId += "-" + Math.floor(getRandomArbitrary(0, 1) * 1000);
        navId += "-" + Math.floor(getRandomArbitrary(0, 1) * 1000);
      }
