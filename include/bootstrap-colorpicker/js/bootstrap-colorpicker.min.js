...
exports.default = {
  ...
  /**
   * If true, loads the 'debbugger' extension automatically, which logs the events in the console
   * @type {boolean}
   * @default false
   */
  debug: false,
   ...
   * Colorpicker comes with many bundled extensions: debbugger, palette, preview and swatches (a superset of palette).
   *
   * @type {Object[]}
   * @example
   *   extensions: [
  ...
  _createClass(Colorpicker, [{
    ...
    value: function initExtensions() {
      ...
      if (this.options.debug) {
        this.options.extensions.push({ name: 'debbugger' });
      }
...
var Debugger = function (_Extension) {
  ...
  _createClass(Debugger, [{
    ...
    value: function log(eventName) {
      ...
      /**
       * Whenever the debbugger logs an event, this other event is emitted.
       *
       * @event DebuggerExtension#colorpickerDebug
       * @type {object} The event object
       * @property {Colorpicker} colorpicker The Colorpicker instance
       * @property {ColorItem} color The color instance
       * @property {{debbugger: DebuggerExtension, eventName: String, logArgs: Array, logMessage: String}} debug
       *  The debug info
       */
